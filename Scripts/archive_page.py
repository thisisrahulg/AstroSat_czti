...
if answer == '1':
    ...
    cztlink = '<td class="rtecenter"><p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://web.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_{}SECBIN_lightcurves.pdf">CZTI_lightcurve</a></span></span></p>'.format(GRB_linkname,GRB_linkname,tbin)
    finallink = cztlink

elif answer == '2':
    vtbin = str(input("  enter veto binning size [ 1 , 5 , 10 ]: "))
    vetolink = '<td class="rtecenter"><p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://web.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_Veto_{}SECBIN_lightcurves.pdf">Veto_lightcurve</a></span></span></p>'.format(GRB_linkname,GRB_linkname,vtbin)
    finallink = vetolink

elif answer == '3':
    tbin = str(input("  enter czt binning size [ 0.1 , 1 , 10 ]: "))
    vtbin = str(input("  enter veto binning size [ 1 , 10 ]: "))
    cztlink = '<p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://web.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_{}SECBIN_lightcurves.pdf">CZTI_lightcurve</a></span></span></p>'.format(GRB_linkname,GRB_linkname,tbin)
    vetolink = '<p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://web.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_Veto_{}SECBIN_lightcurves.pdf">Veto_lightcurve</a></span></span></p>'.format(GRB_linkname,GRB_linkname,vtbin)
...
if compton == 'y':
    complink = '<p><span style="font-size:12px;"><span style="font-family:times new roman,times,serif;"><a href="http://web.iucaa.in/~astrosat/czti_grb/{}/AS1CZT_{}_200_4_compton_events.pdf">Compton_lightcurve</a></span></span></p>'.format(GRB_linkname,GRB_linkname)
...
utc = astime.convertAStoAll(float(AstroSec))[2]
utc = utc[:-4]
utc_time = initial + utc + last
...
new_row = [grb_name,astrosec,utc_time,rd,tp,t90,spectrum]
