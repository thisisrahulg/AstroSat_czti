...
url = 'https://web.iucaa.in/~astrosat/czti_dqr/'
#url = 'http://www.iucaa.in/~astrosat/czti_dqr/'
html = urlopen(url)
s = BeautifulSoup(html, 'lxml')


links = s.find_all('a',href = True, limit = args.stop + 6, target = "_blank")
...
for l in range(args.stop -1,args.start -2,-1):
